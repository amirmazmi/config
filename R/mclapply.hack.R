...
if( Sys.info()[['sysname']] == 'Windows' ){
    message(paste(
        "\n", 
        "[+++] Using mclapply.hack since on Windows \n\n"
...
## the hack version. Otherwise, leave the
## definition alone. 
